...
#PERIPHERALS:=UART
PERIPHERALS ?=UART SEM TIMER ADDER
#PERIPHERALS ?=UART SEM TIMER

#INSTANCES
INST_DIR := $(ROOT_DIR)/instances
INSTANCES := UART0 UART1 SEM TIMER ADDER1 ADDER2 ADDER3 ADDER4 ADDER5 ADDER6 ADDER7 ADDER8 ADDER9 ADDER10 ADDER11 ADDER12 ADDER13 ADDER14 ADDER15 ADDER16
#INSTANCES := UART0 UART1 SEM TIMER
