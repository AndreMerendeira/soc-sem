...
create_pblock RISCV
add_cells_to_pblock [get_pblocks RISCV] [get_cells -quiet [list cache2ddr ddr4_ram system/cpu system/dbus_split system/ext_mem0 system/ibus_split system/int_mem0 system/pbus_split system/timer system/uart_0 system/uart_1]]
resize_pblock [get_pblocks RISCV] -add {CLOCKREGION_X0Y0:CLOCKREGION_X0Y1}

############ Adder Cores ###################

create_pblock Adders
add_cells_to_pblock [get_pblocks Adders] [get_cells -quiet [list system/adder10 system/adder11 system/adder12 system/adder13 system/adder14 system/adder15 system/adder16 system/adder1 system/adder2 system/adder3 system/adder4 system/adder5 system/adder6 system/adder7 system/adder8 system/adder9]]
resize_pblock [get_pblocks Adders] -add {SLICE_X36Y250:SLICE_X42Y270}
set_property EXCLUDE_PLACEMENT 1 [get_pblocks Adders]
