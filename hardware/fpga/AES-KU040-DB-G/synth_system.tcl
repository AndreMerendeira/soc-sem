 ...
 #SEM Core
    ...
    if { [file isdirectory "./ip/sem_ultra_0"] } {
        ...
        create_ip -name sem_ultra -vendor xilinx.com -library ip -version 3.1 -module_name sem_ultra_0 -dir ./ip -force
       	...
       	set_property -dict [list CONFIG.CLOCK_PERIOD {10000} CONFIG.ENABLE_CLASSIFICATION {true} CONFIG.LOCATE_CONFIG_PRIM {core}] [get_ips sem_ultra_0]
...
makedata -ebd synth_system.ebd datafile
